description 'This stack to add a HIPswitch EC2 instance to an existing VPC'
...
parameter :PublicSubnetId, default: '@tnw-vpc.subnetid1'
parameter :ProtectedSubnetId, default: '@tnw-vpc.subnetid2'

# This is the AMI in us-west-2 for a HIPswitch
parameter :ImageId, default: 'ami-506e8d63'
...
resource :instance, "AWS::EC2::Instance" do
  ...
  network_interfaces [ 
      ...
      #SubnetId: Fn::ref(:PublicSubnetId)
      ...
      #AssociatePublicIpAddress: false,
      #GroupSet: [ Fn::ref(:instancesg) ],
      #SubnetId: Fn::ref(:ProtectedSubnetId)
