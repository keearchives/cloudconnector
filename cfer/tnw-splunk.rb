description 'This stack template for a Splunk-lite EC2 instance'
...
#   Read more about the Splunk Light AMI here:
#   http://docs.splunk.com/Documentation/SplunkLight/6.3.0/Installation/AbouttheSplunkAMI
#   https://aws.amazon.com/marketplace/ordering?productId=2743cab7-2adb-4e5c-bda7-0f20777e40e4&ref_=dtl_psb_continue&region=us-west-2
...
# This is the AMI in us-west-2 for a Splunk Light
parameter :ImageId, default: 'ami-dd5349ed'
